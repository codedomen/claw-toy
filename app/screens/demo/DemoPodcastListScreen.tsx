...
const rnrImage1 = require("../../../assets/images/app-icon-flicking-finger.png")
const rnrImage2 = require("../../../assets/images/app-icon-connect-shapes.png")
const rnrImage3 = require("../../../assets/images/app-icon-fingers-gym.png")
const rnrImages = [rnrImage1, rnrImage2, rnrImage3]

export const DemoPodcastListScreen = observer(({ navigation }: NativeStackScreenProps<any>) => {
...
const EpisodeCard = observer(function EpisodeCard({
  ...
  return (
    <Card
      ...
      RightComponent={
        <Image source={imageUri} style={themed($itemThumbnail)} resizeMode={"contain"} />
      }
      FooterComponent={
        <Button
