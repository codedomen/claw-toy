...
import { StartGameScreen } from "@/screens/FlickingFinger/StartGameScreen"

const Tab = createBottomTabNavigator()

const enum FlickingFingerNavigatorScreens {
 ...
 */
export function FlickingFingerNavigator() {
  ...
  return (
    ...
    >
      <Tab.Screen
        name={FlickingFingerNavigatorScreens.CONFIGURATION}
      ...
      <Tab.Screen
        name={FlickingFingerNavigatorScreens.START_GAME}
      ...
      <Tab.Screen
        name={FlickingFingerNavigatorScreens.TUTORIAL}
